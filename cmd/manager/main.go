...
import (
	...
	"github.com/grdryn/dummy-owner-test-operator/pkg/controller"
...
func main() {
	...
	err = leader.Become(ctx, "dummy-owner-test-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	// Setup Scheme for OpenShift Console
	if err := consolev1.AddToScheme(mgr.GetScheme()); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}

	// Setup Scheme for OpenShift Oauth
